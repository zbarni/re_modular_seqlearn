"""
Robustness test on a sequence with 4 elements (each 700 ms).

Used to produce figures 3A, B (left panels);
"""
...
experiment_label = 'robustness_fixed_4x700'
...
# ################################
def build_parameters(w_EE_MT, w_EI_MT, T):
