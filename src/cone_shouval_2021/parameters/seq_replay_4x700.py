"""
Baseline network as in Cone & Shouval (2021) for a sequence with 4 elements (each 700 ms).

Used to produce figures 2 A-C;
"""
...
experiment_label = 'seq_replay_baseline_4x700'
