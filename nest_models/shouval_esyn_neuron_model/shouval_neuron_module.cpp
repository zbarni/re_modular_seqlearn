...
#include "shouval_neuron_module.h"
...
shouval_neuron_module shouval_neuron_module_LTX_mod;
#endif

// -- DynModule functions ------------------------------------------------------

shouval_neuron_module::shouval_neuron_module()
{
#ifdef LINKED_MODULE
...
const std::string
shouval_neuron_module::name(void) const
{
  return std::string("shouval_neuron_module"); // Return name of the module
}

const std::string
shouval_neuron_module::commandstring( void ) const
{
  // Instruct the interpreter to load shouval_neuron_module-init.sli
  return std::string( "(shouval_neuron_module-init) run" );
}

//-------------------------------------------------------------------------------------
void
shouval_neuron_module::init( SLIInterpreter* i )
{
  
    nest::kernel().model_manager.register_node_model<ShouvalNeuron>("ShouvalNeuron");
  

  

} // shouval_neuron_module::init()